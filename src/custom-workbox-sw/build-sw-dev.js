// Note: this version creates a service worker in the public
// directory for development mode.
// Note: this might not work exactly like during production mode
...
const buildSWDevMode = () => {
  ...
  let serviceWorkerDestinationLocation = `public/sw.js`;
